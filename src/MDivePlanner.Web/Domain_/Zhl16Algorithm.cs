...
namespace MDivePlannerWeb.Domain
{
    public class Zhl16Algorithm : IDecoAlgorythm
    {
        ...
        {
            Reset(diveParameters, diveParameters.DiveConfig.AlgoSubType, tissuePreasures);
        ...
        private void Reset(DiveParameters diveParams, SubType type, object tissuePreasures)
        {
            _diveParameters = diveParams;
            _firstDecoStopDepth = 0;
            _trackedDivePointTime = 0;
            _compartments = _compartmentTables[type];
