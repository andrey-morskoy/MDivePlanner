...
export class DiveGraph {
    ...
    private readonly _colorDiveSafeStop: Color = new Color(245, 190, 3);
    ...
    private drawGasesGrapth(depthKoef: number, timeKoef: number): void {
    ...
    private drawDiveProfileGrapth(depthKoef: number, timeKoef: number): void {
    ...
    private drawMarks(depthKoef: number, timeKoef: number): void {
        let ctx = this._context;
        let diveRes = this._diveResult;
        let bottomPoints = 0;
    ...
    private drawLevelsInfo(depthKoef: number, timeKoef: number): void {
        let ctx = this._context;
        let diveRes = this._diveResult;
    ...
    private drawGasSwitches(depthKoef: number, timeKoef: number): void {
        let ctx = this._context;
        let diveRes = this._diveResult;
    ...
    private drawNdl(depthKoef: number, timeKoef: number): void {
        let ctx = this._context;
        let diveRes = this._diveResult;
    ...
    private drawCelingDepthPoints(depthKoef: number, timeKoef: number): void {
        let ctx = this._context;
        let diveRes = this._diveResult;
        let lastPoint = null;
    ...
    private drawBase(): { depthKoef: number, timeKoef: number } {
